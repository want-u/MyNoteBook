...
- --record：将当前命令保存到版本信息
- kubectl rollout history deployment 副本名：查看版本历史
- kubectl rollout undo deployment 副本名 --to-revision=版本号：回滚到指定版本
...
# 回滚到指定版本
[root@k8s-master ~]# kubectl rollout undo deployment httpd --to-revision=4
```
